  ...
  return (
    <div className="login-main">
     ...
     <div className='auth-container-2'>
      { !isSignup && <h2 className='login-logo'>Login</h2>}
      ...
      <form>
        ...
        <label htmlFor="email">
          <h4>Login ID</h4>
          <input type="email" name='email' id='email' placeholder="Enter Login ID"/>
        </label>
        <label htmlFor="password"> 
          ...
          <input    type={values.showPassword ? "text" : "password"}
                ...
                value={values.password} name='password' id='password'  placeholder="Enter Password" />
